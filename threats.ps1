Write-Host "Running Basic Security Check..." -ForegroundColor Cyan
...
Write-Host "`nRunning Processes (with Signature Info):" -ForegroundColor Yellow
...
Write-Host "`nRecent Failed Login Attempts:" -ForegroundColor Yellow
...
Write-Host "`nActive Remote Desktop Sessions:" -ForegroundColor Yellow
query session

Write-Host "`nScan complete. Review above output for anything suspicious." -ForegroundColor Green
